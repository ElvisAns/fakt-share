    ...
    const parts = [
        {
            ...
            Here are the tags we currently want in the app :
            ...
            Please generate ${number} facts and return them in json format. Your reponse shoud contain the post content and the tag as well :
